...
btn_enviar.addEventListener('click', () => {
    ...
    if (isNaN(litros_gasolina) || isNaN(litros_alcool) || isNaN(gasto_total_gasolina) || isNaN(gasto_total_alcool)) {
        dica.innerText = 'Lembre-se de preencher todos os campos'
